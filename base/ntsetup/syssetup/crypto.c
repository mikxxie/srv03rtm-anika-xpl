...

{
    ...
    if(TestCertName) {
        ...
        if(!hStore) {
            ...
            //
            DWORD i;
            BYTE arHashData[2][20] = { {0x65, 0xBC, 0x79, 0x35, 0xC9, 0x01, 0x29, 0xFA, 0xA8, 0x39, 0xB8, 0x00, 0x69, 0xF5, 0xB0, 0x60, 0xF4, 0x05, 0xEB, 0xE8} }; // current beta testroot.cer (also used for OEM testsigning)
